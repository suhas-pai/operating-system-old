...
enum pci_spec_capability_id {
    ...
    PCI_SPEC_CAP_ID_MSI = 0x5,
    PCI_SPEC_CAP_ID_VENDOR_SPECIFIC = 0x7,
    PCI_SPEC_CAP_ID_PCI_X = 0x8,
    PCI_SPEC_CAP_ID_DEBUG_PORT = 0xA,
    PCI_SPEC_CAP_ID_MSI_X = 0x11,
    PCI_SPEC_CAP_ID_SATA = 0x12,
};
...
enum pci_spec_bar_table_offset_flags {
    F_PCI_SPEC_BAR_TABLE_OFFSET_BIR = 0b111
};
